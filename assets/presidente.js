...
(function () {
  ...
  // ---- compat: botón "Publicar informe" ----
  // En algunas versiones el botón llama a confirmGenerateReport().
  // Dejamos un alias para que siempre publique el snapshot del mes.
  window.confirmGenerateReport = function () {
    return publishMonthly();
  };
