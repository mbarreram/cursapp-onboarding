(function(){
  ...
  function renderHome(){
    ...
    root.querySelectorAll('[data-support]').forEach(b=>b.addEventListener('click',()=>openSupportModal(b.dataset.support)));
  }
