(function(){
  ...
  function ensureCss(){
    ...
    var s=document.createElement('style');s.id='mxProfileNativeBottomNavCss';s.textContent=`
      body.cursapp-profile .bottomNav.mxProfileNativeNav{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;align-items:stretch!important;gap:4px!important;width:calc(100% - 28px)!important;max-width:760px!important;left:50%!important;transform:translateX(-50%)!important;bottom:max(10px,env(safe-area-inset-bottom))!important;padding:8px!important;border:1px solid #e2e8f0!important;border-radius:28px!important;background:rgba(255,255,255,.97)!important;box-shadow:0 16px 38px rgba(15,23,42,.14)!important;backdrop-filter:blur(14px)!important;z-index:5000!important}
      ...
      body.cursapp-profile .bottomNav.mxProfileNativeNav.tesBottomNav .navItem.active{background:#eff6ff!important;color:#2563eb!important}
      ...
      body.cursapp-profile .bottomNav.mxProfileNativeNav .nav-label,body.cursapp-profile .bottomNav.mxProfileNativeNav .tesNavLabel{font-size:12px!important;font-weight:850!important;color:inherit!important;text-align:center!important}
      @media(max-width:430px){body.cursapp-profile .bottomNav.mxProfileNativeNav{width:calc(100% - 22px)!important;padding:7px!important}body.cursapp-profile .bottomNav.mxProfileNativeNav .navItem,body.cursapp-profile .bottomNav.mxProfileNativeNav .marketBottomTab{min-height:62px!important;font-size:11.5px!important}}
    `;document.head.appendChild(s);
  }
  function apoderado(){return '<button class="navItem apoderado-bottom-nav-item active" data-tab="home" type="button"><span class="nav-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m3 11 9-8 9 8"/><path d="M5 10v10h14V10"/><path d="M9 20v-6h6v6"/></svg></span><span class="nav-label">Inicio</span></button><button class="navItem apoderado-bottom-nav-item" data-tab="payments" type="button"><span class="nav-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="5" width="18" height="14" rx="3"/><path d="M3 10h18"/><path d="M7 15h4"/></svg></span><span class="nav-label">Pagos</span></button><button class="navItem apoderado-bottom-nav-item" data-tab="informes" type="button"><span class="nav-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 3h9l3 3v15H6V3Z"/><path d="M14 3v4h4"/><path d="M9 13h6"/><path d="M9 17h6"/></svg></span><span class="nav-label">Informes</span></button><a class="marketBottomTab apoderado-bottom-nav-item" href="/mercado-escolar/mercado-escolar.html"><span class="nav-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 10h16l-1-5H5l-1 5Z"/><path d="M6 10v10h12V10"/><path d="M9 20v-6h6v6"/></svg></span><span class="nav-label">Mercado Escolar</span></a>'}
  function presidente(){return '<button class="navItem active" data-tab="home" type="button"><span class="presNavIcon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="m3 11 9-8 9 8"/><path d="M5 10v10h14V10"/><path d="M9 20v-6h6v6"/></svg></span><span>Inicio</span></button><button class="navItem" data-tab="campanas" type="button"><span class="presNavIcon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="m3 11 18-5v12L3 13v-2Z"/><path d="M11 14v4a2 2 0 0 1-2 2H8l-2-6"/></svg></span><span>Campañas</span></button><button class="navItem" data-tab="deudores" type="button"><span class="presNavIcon" aria-hidden="true"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg></span><span>Deudores</span></button><button class="navItem" data-tab="informes" type="button"><span class="presNavIcon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-7"/><path d="M22 20H2"/></svg></span><span>Informes</span></button>'}
