...
(function(){
  ...
  function actionLabel(a){return({registrada:'Rendición registrada',editada:'Rendición corregida y reenviada',aprobada:'Rendición aprobada',rechazada:'Rendición rechazada',observada:'Corrección solicitada'}[a]||String(a||'Movimiento'))}
