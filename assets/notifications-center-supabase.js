(function(){
  ...
  async function load(){
    ...
    // La consulta ya está limitada al usuario autenticado mediante user_id + RLS.
    // No aplicar un segundo filtro por rol/curso: generaba diferencias entre el badge y el modal.
