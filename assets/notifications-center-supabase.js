(function(){
  ...
  async function load(){
    ...
    lastError='';paintBadge();return rows;
  }
  function paintBadge(){
  ...
  async function mark(ids){
    ...
    await sb.request('rpc/mark_my_notifications_read',{method:'POST',body:JSON.stringify({p_ids:ids})});
  ...
  function openPreferences(){
    ...
    alert('Las preferencias todavía no están disponibles. Recarga Cursapp e intenta nuevamente.');
  }
  async function open(){
  ...
  window.CURSAPP_NOTIFICATIONS=Object.assign({},window.CURSAPP_NOTIFICATIONS||{},{open,refresh:load,preferences:openPreferences});
})();
